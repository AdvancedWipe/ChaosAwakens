...
public class EntEntityRenderer extends GeoEntityRenderer<EntEntity> {
  ...
  @Override
  public void renderEarly(EntEntity animatable, MatrixStack stackIn, float ticks,
      VertexConsumerProvider vertexConsumerProvider, VertexConsumer vertexBuilder,
      int packedLightIn, int packedOverlayIn, float red, float green, float blue,
      float partialTicks) {
    this.entEntity = animatable;
    this.vertexConsumerProvider = vertexConsumerProvider;

    super.renderEarly(animatable, stackIn, ticks, vertexConsumerProvider, vertexBuilder,
  ...
  @Override
  public RenderLayer getRenderType(EntEntity animatable, float partialTicks, MatrixStack stack,
