...
public class EntEntity extends HostileEntity implements IAnimatable {
  ...
  private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
    if (event.isMoving()) {
      event.getController().setAnimation(
          new AnimationBuilder().addAnimation("animation.ent.walking_animation", true));
    } else {
      event.getController()
          .setAnimation(new AnimationBuilder().addAnimation("animation.ent.idle_animation", true));
    }
    if (this.isAttacking()) {
      event.getController().setAnimation(
          new AnimationBuilder().addAnimation("animation.ent.attacking_animation", true));
    }
  ...
  protected void initGoals() {
    ...
    this.targetSelector.add(1,
        new FollowTargetGoal(this, SnowGolemEntity.class, true).setMaxTimeWithoutVisibility(30));
    this.targetSelector.add(2,
        new FollowTargetGoal(this, IronGolemEntity.class, true).setMaxTimeWithoutVisibility(30));
    this.targetSelector.add(3,
        new FollowTargetGoal(this, PlayerEntity.class, true).setMaxTimeWithoutVisibility(30));
  }

  @Override
  public void registerControllers(AnimationData animationData) {
    animationData.addAnimationController(
        new AnimationController<EntEntity>(this, "entcontroller", 0, this::predicate));
  }
