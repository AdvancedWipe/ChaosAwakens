...
public class GenericExtendedHitWeaponItem extends SwordItem implements Vanishable, IAnimatable {
  ...
  protected static final UUID ATTACK_KNOCKBACK_MODIFIER_ID = UUID.fromString(
      "C59EC38E-DC43-11EB-BA80-0242AC130004");
  private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;
  public AnimationFactory factory = new AnimationFactory(this);

  public GenericExtendedHitWeaponItem(ToolMaterial toolMaterial, int attackDamage,
      float attackSpeed, float attackKnockback, Settings settings) {
    super(toolMaterial, attackDamage, attackSpeed, settings);
    float attackDamage_2 = (float) attackDamage + toolMaterial.getAttackDamage();
    ImmutableMultimap.Builder<EntityAttribute, EntityAttributeModifier> builder = ImmutableMultimap.builder();
    builder.put(EntityAttributes.GENERIC_ATTACK_DAMAGE,
        new EntityAttributeModifier(ATTACK_DAMAGE_MODIFIER_ID, "Weapon modifier", attackDamage_2,
    ...
    builder.put(EntityAttributes.GENERIC_ATTACK_KNOCKBACK,
        new EntityAttributeModifier(ATTACK_KNOCKBACK_MODIFIER_ID, "Weapon modifier",
            attackKnockback, EntityAttributeModifier.Operation.ADDITION));
