...
public class GenericEnchantedPickaxeItem extends PickaxeItem implements IPreEnchanted {

  private final EnchantmentLevelEntry[] enchantments;

  public GenericEnchantedPickaxeItem(ToolMaterial material, int attackDamage, float attackSpeed,
