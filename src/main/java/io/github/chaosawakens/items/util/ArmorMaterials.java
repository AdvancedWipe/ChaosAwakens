...
public class ArmorMaterials {
  ...
  static {
    EMERALD_ARMOR_MATERIAL = new GenericArmorMaterial(35, new int[]{3, 6, 8, 3}, 24, 2.0f,
        Ingredient.ofItems(net.minecraft.item.Items.EMERALD), "emerald");
    EXPERIENCE_ARMOR_MATERIAL = new GenericArmorMaterial(39, new int[]{4, 7, 9, 5}, 32, 2.5f,
        Ingredient.ofItems(net.minecraft.item.Items.EMERALD), "experience");
    AMETHYST_ARMOR_MATERIAL = new GenericArmorMaterial(38, new int[]{3, 7, 8, 4}, 18, 2.0f,
        Ingredient.ofItems(Items.AMETHYST), "amethyst");
    RUBY_ARMOR_MATERIAL = new GenericArmorMaterial(37, new int[]{4, 8, 9, 4}, 22, 3.0f,
        Ingredient.ofItems(Items.RUBY), "ruby");
    TIGERS_EYE_ARMOR_MATERIAL = new GenericArmorMaterial(36, new int[]{4, 7, 8, 4}, 20, 2.5f,
        Ingredient.ofItems(Items.TIGERS_EYE), "tigers_eye");
    LAPIS_LAZULI_ARMOR_MATERIAL = new GenericArmorMaterial(22, new int[]{2, 5, 7, 2}, 24, 1.75f,
        Ingredient.ofItems(net.minecraft.item.Items.LAPIS_BLOCK), "lapis_lazuli");
    ULTIMATE_ARMOR_MATERIAL = new GenericArmorMaterial(48, new int[]{6, 10, 12, 6}, 64, 4.5f,
